...
// import { motion } from 'framer-motion'
// import { Github, ExternalLink, Folder, Star, GitBranch, Eye } from 'lucide-react'
// import { Card, CardContent, CardDescription, CardFooter, CardHeader, CardTitle } from '@/components/ui/card'
// import { Badge } from '@/components/ui/badge'
// import { Button } from '@/components/ui/button'
...
//             >
//               <Badge variant="outline" className="px-4 py-2 text-lg border-pink-200 bg-pink-50 dark:bg-pink-950/50">
...
//               >
//                 {/* Glow effect */}
//                 <div className={`absolute -inset-0.5 bg-gradient-to-r from-pink-600 to-purple-600 rounded-2xl blur opacity-30 group-hover:opacity-75 transition duration-1000 ${hoveredId === project.id ? 'opacity-75' : ''
//                   }`} />

//                 <Card className="relative h-full flex flex-col bg-background hover:shadow-2xl transition-all duration-300">
//                   {/* Project number */}
//                   <div className="absolute -top-4 -right-4 w-12 h-12 bg-gradient-to-br from-pink-500 to-purple-500 rounded-full flex items-center justify-center text-white font-bold shadow-lg">
//                     {index + 1}
//                   </div>

//                   <CardHeader>
//                     <div className="flex items-start justify-between mb-4">
//                       <div className="p-3 bg-gradient-to-br from-purple-100 to-pink-100 dark:from-purple-900/50 dark:to-pink-900/50 rounded-lg">
...
//                           key={i}
//                           variant="secondary"
//                           className="bg-gradient-to-r from-purple-50 to-pink-50 dark:from-purple-950/50 dark:to-pink-950/50 border-purple-200/50"
//                         >
//                           {tech}
//                         </Badge>
//                       ))}
...
//               size="lg"
//               variant="outline"
//               className="group border-2 hover:border-purple-500"
//             >
//               <a href={projectListUrl} target="_blank" rel="noopener noreferrer" className='flex items-center'>
